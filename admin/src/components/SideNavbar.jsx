    ...
    <div>
      <div>
        <ul className=' text-[#515151] mt-5'>
          ...
          <NavLink className={({isActive})=> ` flex items-center gap-3 py-3.5 px-5 md:px-9 md:min-w-72 cursor-pointer ${isActive ? 'bg-[#F2F3FF] border-r-4 border-[#ff6600]' : ""}`} to={'/stock-management'}>
              {/* <img src={assets.people_icon} alt="" /> */}
              <RailSymbol />
